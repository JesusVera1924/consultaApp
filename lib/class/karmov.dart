...
//
//     final karmov = karmovFromMap(jsonString);
...
class Karmov {
  ...
  factory Karmov.fromMap(Map<String, dynamic> json) => Karmov(
        ...
        cx1Mov: json["cx1_mov"],
        nx1Mov: json["nx1_mov"],
        fx1Mov: DateTime.parse(json["fx1_mov"]),
        cx2Mov: json["cx2_mov"],
        nx2Mov: json["nx2_mov"],
        fx2Mov: DateTime.parse(json["fx2_mov"]),
        codRef: json["cod_ref"],
        nomRef: json["nom_ref"],
        codFb1: json["cod_fb1"],
        codFb2: json["cod_fb2"],
        ...
        stsMov: json["sts_mov"],
        obsMov: json["obs_mov"],
        cdsMov: json["cds_mov"]?.toDouble(),
        sdsMov: json["sds_mov"],
        odsMov: json["ods_mov"],
        adaMov: json["ada_mov"],
        cdaMov: json["cda_mov"]?.toDouble(),
        sdaMov: json["sda_mov"],
        odaMov: json["oda_mov"],
        bodMov: json["bod_mov"],
  ...
  Map<String, dynamic> toMap() => {
        ...
        "cx1_mov": cx1Mov,
        "nx1_mov": nx1Mov,
        "fx1_mov": fx1Mov.toIso8601String(),
        "cx2_mov": cx2Mov,
        "nx2_mov": nx2Mov,
        "fx2_mov": fx2Mov.toIso8601String(),
        "cod_ref": codRef,
        "nom_ref": nomRef,
        "cod_fb1": codFb1,
        "cod_fb2": codFb2,
        ...
        "udu_mov": uduMov,
        "fyt_mov":
            "${fytMov.year.toString().padLeft(4, '0')}-${fytMov.month.toString().padLeft(2, '0')}-${fytMov.day.toString().padLeft(2, '0')}",
      };
}
